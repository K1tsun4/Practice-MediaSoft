...
Реализуйте класс CarDealership (данный класс в моём проекте называется CarCenter), содержащий список автомобилей. У каждой машины:
